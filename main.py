...
def main(args):
    ...
    for edx in range(epoch, max_epochs):
        ...
        for bdx, i_batch in enumerate(train_loader):
            ...
            layer_alpha = 1#linear_decay(0.1, 1, 100, current_time_scaled)
        ...
        print('TRAINING Epoch #{}, Time spent: {}, Total Loss: {}, Embedding Loss: {}, Color Loss: {}, Position Loss: {}'.format(edx, time.time()-startTime, total_losses/train_divide_by, layer_losses/train_divide_by, color_losses/train_divide_by, position_losses/train_divide_by))
        ...
        print('VALIDATION Epoch #{}, Total Loss: {}, Embedding Loss: {}, Color Loss: {}, Position Loss: {}, Patience: {}/{}'.format(edx, total_loss/valid_divide_by, valid_emb_loss/valid_divide_by, valid_color_loss/valid_divide_by, valid_position_loss/valid_divide_by, cur_patience, patience_gating[0]))
